...
import { Button, Container, Divider, Grid, Header, Image, Menu, Segment, Input } from 'semantic-ui-react'
...
const ThemingLayout = () => (
    <Container style={{ marginTop: '3em' }}>
        ...
        <Grid columns={3} stackable>
            <Grid.Column>
                <Header as='h1'>Heading 1 48px</Header>
                <Header as='h2'>Heading 2 36px</Header>
                <Header as='h3'>Heading 3 30px</Header>
                <Header as='h4'>Heading 4 25px</Header>
                <Header as='h5'>Heading 5 20px</Header>
                <Header as='h6'>Heading 6 16px</Header>
        ...
        <Grid columns='equal'>
            ...
            <Grid.Column>
                ...
                <Segment padded>
                    padded segment: 25px
                    HELLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLOOOOOOOOOOOO
